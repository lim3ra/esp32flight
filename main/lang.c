...
static const lang_t k_en = {
    ...
    .overhead_lbl = "NOW OVERHEAD", .overhead_now = "overhead now",
    .overhead_in_s = "in %d s", .overhead_in_min = "in %d min",
...
static const lang_t k_pl = {
    ...
    .overhead_lbl = "TERAZ NAD TOBĄ", .overhead_now = "nad tobą",
    .overhead_in_s = "za %d s", .overhead_in_min = "za %d min",
