...
"catch(e){const st=document.getElementById('cfgstat');"
"if(st)st.textContent='could not load settings ('+e+') - the device may be busy, reload the page';"
"setTimeout(loadCfg,4000);}}"
